 ...
 *
 */
public class RpTransactionMessage_bak extends BaseEntity {
	...
	public RpTransactionMessage_bak() {
		super();
	}


	public RpTransactionMessage_bak(String messageId, String messageBody, String consumerQueue) {
		super();
