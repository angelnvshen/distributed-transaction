package own.stu.distributedTransaction.pay.web.message.api.message;
...
public class APIMessageController {
    ...
    public PageBean listPage(@RequestBody Map<String, Object> paramMap){
        ...
        return rpTransactionMessageService.listPage(pageParam, paramMap);
    }
