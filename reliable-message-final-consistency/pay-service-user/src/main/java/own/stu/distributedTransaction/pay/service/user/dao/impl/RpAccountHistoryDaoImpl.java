 ...
 */
@Repository
public class RpAccountHistoryDaoImpl  extends BaseDaoImpl<RpAccountHistory_bak> implements RpAccountHistoryDao {
	
	public List<RpAccountHistory_bak> listPageByParams(Map<String, Object> params){
	...
	@Override
	public RpAccountHistory_bak getByRequestNo(String requestNo) {
