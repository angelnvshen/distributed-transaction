 ...
 * @版本:
 */
public class RpNotifyRecord_bak extends BaseEntity implements Serializable{
...
//    }
    ...
    public RpNotifyRecord_bak() {
        super();
    }

    public RpNotifyRecord_bak(Date createTime, Date lastNotifyTime, Integer notifyTimes, Integer limitNotifyTimes, String url, String merchantNo,
