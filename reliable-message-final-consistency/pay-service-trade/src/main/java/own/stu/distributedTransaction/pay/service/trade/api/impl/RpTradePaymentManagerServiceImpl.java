...
package own.stu.distributedTransaction.pay.service.trade.api.impl;
...
import own.stu.distributedTransaction.common.core.utils.WeixinConfigUtil;
...
import own.stu.distributedTransaction.pay.service.trade.entity.weixinpay.WeiXinPrePay;
import own.stu.distributedTransaction.pay.service.trade.enums.OrderFromEnum;
import own.stu.distributedTransaction.pay.service.trade.enums.TradeStatusEnum;
import own.stu.distributedTransaction.pay.service.trade.enums.alipay.AliPayTradeStateEnum;
import own.stu.distributedTransaction.pay.service.trade.enums.weixinpay.WeiXinTradeTypeEnum;
import own.stu.distributedTransaction.pay.service.trade.enums.weixinpay.WeixinTradeStateEnum;
import own.stu.distributedTransaction.pay.service.trade.exceptions.TradeBizException;
import own.stu.distributedTransaction.pay.service.trade.utils.MerchantApiUtil;
...
import own.stu.distributedTransaction.pay.service.trade.utils.alipay.util.AlipayNotify;
import own.stu.distributedTransaction.pay.service.trade.utils.alipay.util.AlipaySubmit;
...
import own.stu.distributedTransaction.pay.service.trade.vo.ScanPayResultVo;
import own.stu.distributedTransaction.pay.service.user.api.*;
...
//    private RpTradePaymentOrderDao rpTradePaymentOrderDao;
    ...
    @Autowired
    private RpTradePaymentQueryService paymentQueryService;
    ...
    public String buildTrxNo() {
        ...
        try {
            // 获取用户编号序列
            trxNoSeq = rpTradePaymentRecordDao.buildTrxNoSeq();
    ...
    public String buildBankOrderNo() {
        ...
        try {
            bankOrderNoSeq = rpTradePaymentRecordDao.buildBankOrderNoSeq();
    ...
    public ScanPayResultVo initDirectScanPay(String payKey, String productName, String orderNo, Date orderDate, Date orderTime, BigDecimal orderPrice, String payWayCode, String orderIp, Integer orderPeriod, String returnUrl, String notifyUrl, String remark, String field1, String field2, String field3, String field4, String field5) {
        ...
        // 先判断支付订单是否已存在
        RpTradePaymentOrder rpTradePaymentOrder = this.selectByMerchantNoAndMerchantOrderNo(merchantNo, orderNo);
    ...
    public void completeScanPay(String payWayCode, Map<String, String> notifyMap) {
        ...
        RpTradePaymentRecord rpTradePaymentRecord = paymentQueryService.getRecordByBankOrderNo(bankOrderNo);
    ...
    private void completeSuccessOrder(RpTradePaymentRecord rpTradePaymentRecord, String bankTrxNo, Date timeEnd, String bankReturnMsg) {
        ...
        rpTradePaymentRecordDao.updateByPrimaryKeySelective(rpTradePaymentRecord);

        // 修改支付订单状态
        RpTradePaymentOrder rpTradePaymentOrder = this.selectByMerchantNoAndMerchantOrderNo(rpTradePaymentRecord.getMerchantNo(), rpTradePaymentRecord.getMerchantOrderNo());
        rpTradePaymentOrder.setStatus(TradeStatusEnum.SUCCESS.name());
        rpTradePaymentOrderDao.updateByPrimaryKeySelective(rpTradePaymentOrder);
    ...
    private RpTransactionMessage sealRpTransactionMessage(RpTradePaymentRecord rpTradePaymentRecord) {
        ...
        rpAccountingVoucher.setPayerChangeAmount(new BigDecimal("0"));//付款方变动金额
        ...
        rpAccountingVoucher.setPayerFee(new BigDecimal("0"));//付款方手续费
        rpAccountingVoucher.setBankChangeAmount(rpTradePaymentRecord.getOrderAmount());//银行订单金额
        rpAccountingVoucher.setReceiverChangeAmount(rpTradePaymentRecord.getOrderAmount());
        ...
        rpAccountingVoucher.setPayAmount(new BigDecimal("0"));
        rpAccountingVoucher.setReceiverAccountType(1);
        rpAccountingVoucher.setReceiverFee(rpTradePaymentRecord.getReceiverFee() == null ? new BigDecimal("0") : rpTradePaymentRecord.getReceiverFee());
    ...
    private RpTradePaymentRecord sealRpTradePaymentRecord(String merchantNo, String merchantName, String productName, String orderNo, BigDecimal orderPrice, String payWay, String payWayName, String fundIntoType, BigDecimal feeRate,
        ...
        String trxNo = this.buildTrxNo();
        rpTradePaymentRecord.setTrxNo(trxNo);//支付流水号

        String bankOrderNo = this.buildBankOrderNo();
    ...
    public String getNotifySendStr(String notifyUrl, String merchantOrderNo, String merchantNo) {
        ...
        RpNotifyRecord_bak record = new RpNotifyRecord_bak();
