...
<body>
	<div id="login">
		<div id="login_header">
			<h1 class="login_logo">
				<a href="http://www" target="_blank"><img src="${baseURL }/dwz/themes/default/images/login_logo-bak.png" /></a>
			</h1>
		...
		<div id="login_content">
			...
			<div class="login_banner"><img src="${baseURL }/dwz/themes/default/images/login_banner-bak.jpg" /></div>
		...
		<div id="login_footer">
			Copyright &copy; 2018-2019 <a href="http://www" target="_blank"></a>
		</div>
	</div>
</body>
</html>